                    ...
                    <thead class="table-dark text-center">
                      ...
                      <tbody>
                        <tr class="table-dark text-center">
                          <th scope="row"><button class="btn btn-primary" @click="getInventary">Filtrar</button></th>
                          <td><input type="text" class="form-control" v-model="filter.patrimonial_code"></td>
                          <td><input type="text" class="form-control" v-model="filter.denomination"></td>
                          <td><input type="text" class="form-control" v-model="filter.brand"></td>
                          <td><input type="text" class="form-control" v-model="filter.model"></td>
                          <td><input type="text" class="form-control" v-model="filter.color"></td>
                          <td><input type="text" class="form-control" v-model="filter.serie"></td>
                          <td><input type="text" class="form-control" v-model="filter.lot"></td>
...
<script>
    ...
    methods: {
      getInventary: async function(){
        let response;
        try {
          response = await axios.get(`${process.env.VUE_APP_API_URL}/inventary/${0}/${20}`, {
            headers:{
